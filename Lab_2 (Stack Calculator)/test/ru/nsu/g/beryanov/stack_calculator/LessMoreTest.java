...
public class LessMoreTest {
    ...
    @Test
    public void lessTest() throws IOException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
    ...
    @Test
    public void moreTest() throws IOException, ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Properties prop = new Properties();
        ...
        Calculator.getWordStack().push(8);
        String temp = ">";
        temp = prop.getProperty(temp);
        temp = temp.substring(0, 1).toUpperCase() + temp.substring(1).toLowerCase();
        Operation op = (Operation) Class.forName("ru.nsu.g.beryanov.stack_calculator." + temp).getDeclaredConstructor().newInstance();
